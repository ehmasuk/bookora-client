  ...
  return (
    <div className="flex gap-3 align-center">
      <div
        ...
        className={`cursor-pointer bg-blue-100 border dark:border-zinc-800 border-zinc-100 rounded text-sm [&.active]:bg-blue-200 [&.active]:text-slate-800 dark:bg-slate-800 text-slate-800 dark:text-white hover:bg-blue-200 size-7 grid place-items-center  ${
